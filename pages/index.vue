      ...
      <div class="relative max-w-md mx-auto md:max-w-2xl min-w-0 break-words bg-white w-full mb-10 shadow-lg rounded-xl mt-24">
        <div class="px-6">
          ...
          <div class="text-center mt-20">
            <h3 class="text-2xl text-slate-700 font-bold leading-normal mb-1">Kalyn Davis</h3>
            <div class="text-s mt-0 mb-2 text-slate-700 font-bold uppercase">
              Full-Stack Engineer
            </div>
            <div class="text-xs mt-0 mb-2 text-slate-400 uppercase">
              Laravel, Swift, Vue
            </div>
          </div>
          ...
          <div class="mt-6 py-6 border-t border-slate-200 text-center">
            <div class="flex flex-wrap justify-center">
              <div class="w-full px-4">
                <p class="font-light leading-relaxed text-slate-600 mb-4">An explorer of life through technology, Kalyn resides in the Birmingham area of Alabama working as a Senior Software Engineer in Sports Tech. When he isn't trying out a new hobby, Kalyn enjoys spending time with his 2 Australian Shepherds.
                  </p>
